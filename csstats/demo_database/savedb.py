        ...
        with transaction.atomic():
            ...
            for _, row in info.iterrows():
                ...
                for _, row2 in scoreboard[
                    ...
                    buy_type = BuyType.objects.get(
                        code=row2["equip_value_name"]
                    )
            ...
            for _, row in rounds.iterrows():
                buy_type_t = BuyType.objects.get(
                    code=row["equip_value_name_t"]
                )
                buy_type_ct = BuyType.objects.get(
                    code=row["equip_value_name_ct"]
                )
                win_reason = WinReason.objects.get(
                    code=row["round_win_reason"]
                )
                ...
                for _, row2 in kills_in_round[
                    ...
                    victim_side = Side.objects.get(
                        code=row2["victim_team_name"]
                    )
